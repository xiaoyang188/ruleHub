...
const DOC_LINKS = [
  ...
  { href: "/developers", label: "开发者门户", desc: "OpenAPI / MCP 接入", api: true },
];

const visibleDocLinks = DOC_LINKS.filter(
  (link) => siteFeatures.showApiDocs || !link.api
);
